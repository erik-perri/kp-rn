...
* 'configure.py --amalgamation --disable-shared --os=android --cc=clang --cpu=arm64 --minimized-build --enable-modules=aes,argon2,argon2_ssse3,auto_rng,bcrypt_pbkdf,chacha,hash,hmac,mac,pbkdf2,rsa,salsa20,sha2_32,sodium,twofish,uuid'
*
* Target
*  - Compiler: /home/erik/Android/ndk-bundle/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android28-clang++ -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: arm64
*  - OS: android
*/
...
#define BOTAN_VERSION_VC_REVISION "git:a85eaffe863a401ba312be5e1403bca80e70221e"
